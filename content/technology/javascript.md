...
<main class="tech-main2">
    <div class="tech-body-text"><p>JavaScript är ett prototyp-baserat skriptspråk. JavaScript utgör tillsammans med HTML och CSS grunden för webben. JavaScript är dynamiskt, svagt typat och hanterar funktioner som första-klass-objekt.
...
<pre><code class="box-text">for (let i = 1; i &#60;= 100; i++) {
    if (!(i % 2)) {
        console.log(i);
    }
}</code></pre>